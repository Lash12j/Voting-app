      ...
      <div class="modal-content" (click)="$event.stopPropagation()">
        ...
        <form (ngSubmit)="onSubmit()" class="modal-form">
          ...
          <div class="modal-actions">
            ...
            <button type="submit" class="btn btn-submit" [disabled]="isSubmitting || !voterName.trim()">
...
export class AddVoterModalComponent {
  ...
  @Output() addVoter = new EventEmitter<string>();
  ...
  onSubmit() {
    ...
    this.addVoter.emit(this.voterName.trim());
  }
